...
@Component({
    selector   : 'uniKnowledge-nav-vertical-collapse',
...
export class UniKnowledgeNavVerticalCollapseComponent implements OnInit
{
    @Input() item: any;
    ...
    )
    {
        ...
        this.uniKnowledgeNavigationService.onNavCollapseToggled
            .subscribe(
                (clickedItem) => {
    ...
    toggleOpen(ev)
    {
        ...
        this.uniKnowledgeNavigationService.onNavCollapseToggled.emit(this.item);
        this.uniKnowledgeNavigationService.onNavCollapseToggle.emit();
    }
