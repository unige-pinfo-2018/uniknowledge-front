...
import { UniKnowledgeNavigationModelInterface } from './navigation.model';

@Injectable()
export class UniKnowledgeNavigationService
{
    onNavCollapseToggle = new EventEmitter<any>();
    onNavCollapseToggled = new EventEmitter<any>();
    onNavigationModelChange: BehaviorSubject<any> = new BehaviorSubject({});
    navigationModel: UniKnowledgeNavigationModelInterface;
    flatNavigation: any[] = [];
